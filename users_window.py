...
class ReadersWin(QMainWindow):
    ...
    def __init__(self):
        ...
        self.tel_entry = QLineEdit(self, placeholderText='rang')
        ...
        self.show_button = QPushButton('Огласить список', self)
        self.show_button.move(150, 240)
    ...
    def add_reader(self):
        ...
        self.cur.execute('INSERT OR REPLACE INTO users (id, name, books, rang, telephone number) VALUES (?, ?, ?, ?)',
...
if __name__ == '__main__':
    ...
    users_win = ReadersWin()  # создаем обьект класс
    users_win.show()  # выводим его на экран
